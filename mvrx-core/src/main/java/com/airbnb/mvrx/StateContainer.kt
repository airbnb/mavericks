 ...
 */
fun <A : MavericksStateModel<B>, B : MavericksState, C> withState(viewModel1: A, block: (B) -> C) = block(viewModel1.state)

/**
 * Accesses ViewModel state from two ViewModels synchronously and returns the result of the block.
 */
fun <A : MavericksStateModel<B>, B : MavericksState, C : MavericksStateModel<D>, D : MavericksState, E> withState(
    viewModel1: A,
    viewModel2: C,
    block: (B, D) -> E
 ...
 */
fun <A : MavericksStateModel<B>, B : MavericksState, C : MavericksStateModel<D>, D : MavericksState, E : MavericksStateModel<F>, F : MavericksState, G> withState(
    viewModel1: A,
    viewModel2: C,
    viewModel3: E,
    block: (B, D, F) -> G
 ...
 */
fun <
    A : MavericksStateModel<B>, B : MavericksState,
    C : MavericksStateModel<D>, D : MavericksState,
    E : MavericksStateModel<F>, F : MavericksState,
    G : MavericksStateModel<H>, H : MavericksState,
    I
...
fun <
    ...
    E : MavericksStateModel<F>, F : MavericksState,
    G : MavericksStateModel<H>, H : MavericksState,
    I : MavericksStateModel<J>, J : MavericksState,
    K
