...
import com.airbnb.mvrx.todomvrx.addedittask.AddEditTaskFragment
import com.airbnb.mvrx.todomvrx.taskdetail.TaskDetailFragment.Companion.REQUEST_EDIT_TASK
...
import com.airbnb.mvrx.todomvrx.util.replaceFragmentInActivity
import com.airbnb.mvrx.todomvrx.util.setupActionBar
...
//        taskViewModel = obtainViewModel()
    ...
    private fun findOrCreateViewFragment() =
            supportFragmentManager.findFragmentById(R.id.contentFrame) ?: TaskDetailFragment.newInstance(intent.getStringExtra(EXTRA_TASK_ID))
